...
public interface HeliosCrypto {
     ...
     */
    byte[] encryptAESKey(PublicKey encryptionRSAKey, SecretKey AESKey) throws CryptoException;
     ...
     */
    SecretKey decryptAESKey(PrivateKey decryptionRSAKey, byte[] encryptedAESKey) throws CryptoException;
     ...
     */
    byte[] encryptBytes(byte[] plaintextBytes, SecretKey AESKey, byte[] iv) throws CryptoException;
     ...
     */
    byte[] decryptBytes(byte[] cryptotextBytes, SecretKey AESKey, byte[] iv) throws CryptoException;
    ...
    byte[] decryptMessage(byte[] data, PrivateKey privateKey) throws  CryptoException;

    MessageAndKey encryptMessage(PublicKey publicKey, AbstractMessage abstractMessage) throws  CryptoException;
